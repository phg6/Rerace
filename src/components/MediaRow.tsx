      ...
      <div className="container-site mb-4 flex items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="hidden h-9 w-9 items-center justify-center rounded-full border border-white/[0.1] bg-white/[0.05] text-zinc-300 backdrop-blur transition hover:border-race/60 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-race lg:flex"
          >
